      ...
      <div className="loginFormContainer">
        ...
        <form className="loginForm" name="login" onSubmit={_login}>
          ...
          <div className="loginFormDiv">
            <input
              className="usernameInput loginInputBox"
              value={username}
          ...
          <div className="loginFormDiv">
            <input
              className="passwordInput loginInputBox"
              type="password"
              value={password}
          ...
          {loginStatus === "N/A" && (
            <span style={{ display: "flex", alignItems: "center" }}>
              ...
              />
              <h4>
                Couldn't find a user with these credentials, create an account
                below
              </h4>
            </span>
          )}
          {loginStatus === "wrongPass" && (
            <div>
              <span style={{ display: "flex", alignItems: "center" }}>
                ...
                />
                <h4>
                  The password associated with this username is different than
                  the one provided, please try again. If you have forgotten your
                  password you may reset it below
                </h4>
              </span>
